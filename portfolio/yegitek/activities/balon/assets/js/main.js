...
const GameEngine = {
    ...
    sounds: {
        correct: new Audio('assets/audio/correct.mp3'), // Placeholder
        wrong: new Audio('assets/audio/wrong.mp3')      // Placeholder
    },
    ...
    showCorrect: function (message = "Harikasın! Doğru Cevap!") {
        ...
        modalContent.className = 'modal-content modal-content-kid modal-success';

        modalTitle.innerHTML = '<span class="feedback-icon">🌟</span> Tebrikler!';
        modalBody.innerHTML = `
    ...
    showTryAgain: function (message = "Tekrar deneyelim, başarabilirsin!") {
        ...
        modalContent.className = 'modal-content modal-content-kid modal-fail';

        modalTitle.innerHTML = '<span class="feedback-icon">🤔</span> Hımm...';
        modalBody.innerHTML = `
            <div class="text-center animate-pop">
