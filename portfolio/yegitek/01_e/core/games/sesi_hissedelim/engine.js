        ...
        window.SesiBulGame = {
            ...
            checkAnswer: function () {
                ...
                if (isCorrect) {
                    ...
                    const snd = new Audio(`${window.ASSETS_PATH}audio/${this.folderPrefix}/correct.mp3`);
                    snd.play().catch(e => console.warn('correct.mp3 missing', e));
                    this.handleSuccess();
                } else {
                    console.log("Answer is WRONG");
                    const snd = new Audio(`${window.ASSETS_PATH}audio/${this.folderPrefix}/wrong.mp3`);
            ...
            showFinishScreen: function () {
                const snd = new Audio(`${window.ASSETS_PATH}audio/${this.folderPrefix}/harikasin_dogru_cevapladin.mp3`);
