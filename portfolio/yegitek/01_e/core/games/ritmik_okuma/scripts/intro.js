...
window.RitmikOkumaIntro = {
    ...
    setupAudio: function () {
        ...
        const audioPath = window.ASSETS_PATH + 'audio/' + this.data.folderPrefix + '/' + (this.data.audio?.instruction || 'instruction.mp3');
...
window.RitmikOkumaInstruction = {
    init: function () {
        ...
        if (!window.RitmikOkumaIntro.audio) {
            const audioPath = window.ASSETS_PATH + 'audio/' + window.RitmikOkumaIntro.data.folderPrefix + '/' + (window.RitmikOkumaIntro.data.audio?.instruction || 'instruction.mp3');
