...
class HeceSozcukEngine {
                ...
                <div class="game-board game-board-hece" style="flex-direction:column;justify-content:center;background-image:url('${bgPath}');">
                    <div class="circuit-wrapper" style="justify-content:flex-start;padding-top:20px;flex-direction:column;align-items:center;">
                        <div class="circuit-container" style="position:relative;text-align:center;display:flex;justify-content:center;height:auto;">
                            ...
                            <div class="drop-zones-overlay" style="position:absolute;bottom:3%;width:100%;display:flex;justify-content:center;gap:50px;align-items:flex-end;">
    ...
    initLevel(index) {
        ...
        this.slot0.innerHTML = ''; this.slot1.innerHTML = '';
        this.slot0.classList.remove('filled'); this.slot1.classList.remove('filled');
    ...
    bindSlots() {
        [this.slot0, this.slot1].forEach(slot => {
    ...
    handleDrop(slot, item) {
        ...
        if (droppedText === correctText) {
            ...
            if (this.checkCompletion()) {
                ...
                this.playSound(droppedText + '.mp3');
            }
        } else {
            this.wrongAttempts++;
    ...
    checkCompletion() { return this.slot0.hasChildNodes() && this.slot1.hasChildNodes(); }
    ...
    handleLevelSuccess(lastSyllable) {
        ...
        const syllableAudio = new Audio(`${folder}${lastSyllable}.mp3`);
