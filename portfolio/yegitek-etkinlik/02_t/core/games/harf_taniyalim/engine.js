...
class HarfTaniyalimEngine {
    constructor(data) {
        ...
        // Audio Objects
        const coreAudioBase = '../games/harf_taniyalim/assets/audio/';
        this.audioCorrect = new Audio(coreAudioBase + 'correct.mp3');
        this.audioWrong = new Audio(coreAudioBase + 'wrong.mp3');
        this.audioTryAgain = new Audio(coreAudioBase + 'try_again.mp3');
        this.audioCongrats = new Audio(coreAudioBase + 'congratulations.mp3');
