...
let var_step_3 = player.GetVar("var_step_3");
let var_step_4 = player.GetVar("var_step_4");
let completed = player.GetVar("completed");

var gameAnimation = document.querySelector('[data-model-id="6bgcHOvM5GS"]');
var videoAnimation = document.querySelector('[data-model-id="5i1VSlOxn0Q"]');
var finalAnimation = document.querySelector('[data-model-id="6GvlMpjMsuB"]');
...
else if(pageNumber === 2)
{
	if(var_step_2===1)
	{
		...
		gameAnimation.style.display = 'block';
	}
	else{
		gameAnimation.style.display = 'none';
		videoAnimation.style.display = 'none';
...
var mainPage = document.querySelector('[data-model-id="6bgcHOvM5GS"]');
var tryAgain = document.querySelector('[data-model-id="6ZwEddJTApL"]');
var hintPage = document.querySelector('[data-model-id="5ZhH1D2YJGR"]');
